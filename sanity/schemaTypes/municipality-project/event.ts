...
// fields — every document in this project already belongs to this
// committee. See sanity/schemaTypes/event.ts for the county-project variant.
export const eventType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Location Name',
      type: 'string',
      description: 'e.g. Fox Chapel Community Center',
    }),
    defineField({
